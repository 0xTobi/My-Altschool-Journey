...
//Technically, the getData function is asynchronous, and we should be able to do the following:
// await getData(url) 
// But we can't do that here, because await is only valid within an async function.
